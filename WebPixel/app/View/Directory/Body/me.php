    ...
    <div class="container">
        ...
        <section class="dashboard-hero">
            <div class="dashboard-welcome">
                <img src="https://www.habbo.es/habbo-imaging/avatarimage?figure=<?php echo rawurlencode($UData['look']); ?>&amp;size=l&amp;direction=2&amp;head_direction=3&amp;gesture=sml" alt="<?php echo htmlspecialchars($UData['username'], ENT_QUOTES, 'UTF-8'); ?>">
                <div>
