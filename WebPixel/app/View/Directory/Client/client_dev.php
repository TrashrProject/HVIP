...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en" xmlns:og="http://opengraphprotocol.org/schema/" xmlns:fb="http://www.facebook.com/2008/fbml">
	<head>
		...
		<script src="<?php echo WS_DY;?>/ws_resources/js/adsense.js"></script>

		<!-- Global site tag (gtag.js) - Google Ads: 394514518 -->
<script async src="https://www.googletagmanager.com/gtag/js?id=AW-394514518"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'AW-394514518');
</script>

<!-- Event snippet for Registro conversion page -->
<script>
  gtag('event', 'conversion', {'send_to': 'AW-394514518/7NNhCOrV4_0BENagj7wB'});
</script>
...
<script>
  ...
  gtag('config', 'UA-55948081-2');
    ...
    <body>
		...
		<iframe src="https://dev.habbovip.us/index.html?sso=<?php echo $ClientAUTH; ?>" class="Nitro">
		</iframe>

		<!--<div id="AdBox3">
		    <div id="avoid3"></div>
		    <div id="exitb3"></div>
		    <div id="AdBox33" class="item3" style="position: absolute;">
		    	< !-- ad2.php by js- ->
		    </div>		    
		</div>-->
		<!-- END Google ADS -->
	...
	<script type="text/javascript">
	   ...
	   /* $(function(){
	        ...
	        var random = Math.floor(Math.random() * $('.item3').length);
	        $('.item3').hide().eq(random).show();
	        var TimesMoved = 0;
	        var TimesToBeMove = Math.floor(Math.random() * (6 - 2 + 1)) + 2;
	    
	        setInterval(function() { $.get("/ad2.php",function(data){
	          $("#AdBox33").html(data);
	          $('#AdBox3').fadeIn(9500);
	        }); }, 2100000);

	        $.get("/ad2.php",function(data){
	          $("#AdBox33").html(data);
	          $('#AdBox3').fadeIn(9500);
	        }); 
