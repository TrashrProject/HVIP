...
var rdp = {
			...
			case 'compose_camionero':
			{
				...
				switch(Action)
				{
					case "open":
						...
						$('#PayListDrug').html("<li><ul style='color:red'>" + Med + " Medicamentos</ul><ul style='color:red'>" + Crack + " g. de Crack</ul></li>");
						$('#PayListGun').html("<li><ul style='color:red'>" + Piezas + " piezas de armas</ul><ul style='color:transparent'>-</ul></li>");
						$('#CargasInfo').show();
					break;
					case "cammsg":
			...
			case 'compose_business': {
				...
				switch(Action)
				{
					...
					case "settings":
						...
						var RankLook = "https://nitro-imager.kubbo.city/?head_direction=4&direction=4&figure=hd-180-1."+ EventData[3] +"&gender=M";
	...
	initStadistics: function(usersdata, clear){
		...
		if(!clear)
		{
			...
			var AvatarFigure = "https://nitro-imager.kubbo.ch/?figure=" + UsersFigure + "&gesture=sml";
			...
			if(UserID == flashvars['account_id'])
			{
				...
				AvatarFigure = "https://nitro-imager.kubbo.ch/?figure=" + UsersFigure + "&gesture=sml&direction=4";
				// Username
