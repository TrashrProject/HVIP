/*
    ...
    // Look Default. 
    AG.importFigure( "lg.hd-180-1.ch.cc.hr.sh.ha.he.ea.fa.ca.wa.cp" );
    AG.loadToClothes( "hd" );
    AG.loadToColors( "hd" );
    AG.updateAvatar();
    ...
    $( '#avatarSelector' ).on( 'click', 'a[data-clothing]', function()
    {
        ...
        var color = ( typeof current.color === "undefined" || current.color == "" ) ? "1" : current.color;
    ...
    function AvatarGenerate()
    {
        ...
        this.importFigure = function( figure, all = false )
        {
        ...
        this.importFigureFemale = function( figure )
        {
            var arrayFigure = figure.split( "." );
        ...
        this.loadToClothes = function( type )
        {
            ...
            jQuery.each( load.sets, function( index, value )
            {
                if( value.gender == _this.gender && value.selectable == 1 || value.gender == "U" && value.selectable == 1 )
                {
                    ...
                    asset.css( 'background-image', 'url( https://nitro-imager.kubbo.ch/?figure=' + partString + '&gender=' + _this.gender + ' )' );
        ...
        {
            var URL = "https://nitro-imager.kubbo.city/?head_direction=4&direction=4&figure=" + this.buildFigure() + "&gender=" + this.getGender();
