...
function tunes_url($value, bool $required = false): ?string {
    ...
    if ($required && ($host === 'youtu.be' || str_ends_with($host, '.youtube.com') || $host === 'youtube.com')) throw new InvalidArgumentException('Les liens YouTube ne sont pas des sources audio directes compatibles.');
    return $url;
}
