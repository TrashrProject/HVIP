/* ParadiseRP — dossier joueur dynamique moderne */
(() => {
  'use strict';
  ...
  function ensureOverlay() {
    ...
    o.innerHTML = `
      ...
      <header class="hvip-rp-dossier-head">
        <div><span class="hvip-rp-eyebrow">DOSSIER CITOYEN</span><div class="hvip-rp-live"><i></i> PRÉSENT</div></div>
        <button type="button" class="hvip-rp-dossier-close" aria-label="Fermer">×</button>
      </header>
      <section class="hvip-rp-identity">
        <div class="hvip-rp-portrait"><div class="hvip-rp-portrait-grid"></div><img class="hvip-rp-dossier-avatar" alt="Avatar"><span class="hvip-rp-id-label">IDENTITÉ VISUELLE</span></div>
        <div class="hvip-rp-person"><span class="hvip-rp-mini-label">IDENTITÉ</span><strong class="hvip-rp-dossier-name">Joueur</strong><span class="hvip-rp-dossier-sub">Profil rôleplay actif</span><div class="hvip-rp-badge-box"><span class="hvip-rp-mini-label">INSIGNE</span><div class="hvip-rp-badge-stage"><img class="hvip-rp-dossier-badge" alt="Badge"></div></div></div>
      </section>
      <section class="hvip-rp-info-card"><span class="hvip-rp-mini-label">FONCTION / MÉTIER</span><div class="hvip-rp-role-line"><span class="hvip-rp-role-mark">◆</span><strong class="hvip-rp-dossier-role">Citoyen</strong></div></section>
      <section class="hvip-rp-rep-card"><div class="hvip-rp-rep-top"><div><span class="hvip-rp-mini-label">RÉPUTATION RP</span><strong class="hvip-rp-dossier-reward">0</strong></div><span class="hvip-rp-rep-grade">NEUTRE</span></div><div class="hvip-rp-rep-track"><span></span></div></section>
      <footer class="hvip-rp-dossier-foot">Cliquez sur un joueur pour consulter son dossier RP.</footer>`;
  ...
  function render(card, rewardNode) {
    ...
    const score=Math.max(0,Math.min(100,Number(data.reward)||0));
    o.querySelector('.hvip-rp-rep-track span').style.width=score+'%';
  ...
  function start(){
    ...
    document.addEventListener('click',()=>{setTimeout(refresh,50);setTimeout(refresh,160);},true);
  }
