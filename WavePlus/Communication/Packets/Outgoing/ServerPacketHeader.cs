namespace Plus.Communication.Packets.Outgoing
{
    ...
    {
        // Roleplay packets
        public const int GuideSessionPartnerIsPlayingMessageComposer = 448;
        public const int WardrobeConfigMessageComposer = 5001;
        public const int PhoneBankMessageComposer = 6007;
        public const int GameClockMessageComposer = 6008;
        public const int AtmBankMessageComposer = 6006;
        public const int AnotherStatsMessageComposer = 6005;
        public const int UserStatsMessageComposer = 6004;
        public const int WantedListMessageComposer = 6003;
        public const int OfferItemMessageComposer = 6002;
        public const int OpenAtmMessageComposer = 6001;
        public const int TargetLockMessageComposer = 6000;
        public const int MyPhotosMessageComposer = 6010;
        public const int ChatLinkConfigMessageComposer = 6011;
        public const int ClientVisualSettingsMessageComposer = 6014;
        public const int TeleportDissolveMessageComposer = 6015;
        public const int GangDataMessageComposer = 6110;
        public const int GangNoticeMessageComposer = 6111;
        public const int GangToggleMessageComposer = 6121;
        public const int RoomInitDataMessageComposer = 6122;

        // Clothing shit
        public const int ClothingStoreMessageComposer = 6130;
        public const int ClothingPurchaseResultMessageComposer = 6131;

        // credit to Keorich##1440 for the headers for Production-201611291003-338511768
        public const int UserNftChatStylesMessageComposer = 6100;
        ...
        public const int AvatarWalkSpeedMessageComposer = 6016; // PRODUCTION-201611291003-338511768
        ...
        public const int CameraPublishStatusMessageComposer = 2057; // matches Nitro IncomingHeader.CAMERA_PUBLISH_STATUS
        ...
        public const int CraftingResultMessageComposer = 618; // PRODUCTION-201611291003-338511768
