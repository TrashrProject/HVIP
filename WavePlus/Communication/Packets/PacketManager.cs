...
using Plus.Communication.Packets.Incoming.Roleplay;
...
namespace Plus.Communication.Packets
{
    public sealed class PacketManager
    {
        ...
        {
            _incomingPackets.Add(ClientPacketHeader.GetCameraPriceEvent, new Incoming.Camera.GetCameraPriceEvent());
            _incomingPackets.Add(ClientPacketHeader.RenderRoomEvent, new Incoming.Camera.RenderRoomEvent());
            _incomingPackets.Add(ClientPacketHeader.SetRoomThumbnailMessageEvent, new Incoming.Camera.RenderRoomThumbnailEvent());
            _incomingPackets.Add(ClientPacketHeader.PurchasePhotoEvent, new Incoming.Camera.PurchasePhotoEvent());
            _incomingPackets.Add(ClientPacketHeader.PublishPhotoEvent, new Incoming.Camera.PublishPhotoEvent());
            _incomingPackets.Add(ClientPacketHeader.RequestMyPhotosMessageEvent, new Incoming.Camera.RequestMyPhotosEvent());
        }

        private void RegisterRoleplay()
        {
            _incomingPackets.Add(ClientPacketHeader.RequestWantedListMessageEvent, new RequestWantedListEvent());
            _incomingPackets.Add(ClientPacketHeader.RequestChatLinkConfigMessageEvent, new RequestChatLinkConfigEvent());
            _incomingPackets.Add(ClientPacketHeader.RequestGameClockMessageEvent, new RequestGameClockEvent());
            _incomingPackets.Add(ClientPacketHeader.RequestBankDataMessageEvent, new RequestBankDataEvent());
            _incomingPackets.Add(ClientPacketHeader.RequestWearingBadgesMessageEvent, new RequestWearingBadgesEvent());
            _incomingPackets.Add(ClientPacketHeader.RpTargetUserMessageEvent, new RpTargetUserEvent());
            _incomingPackets.Add(ClientPacketHeader.SpendAttributePointMessageEvent, new SpendAttributePointEvent());
            _incomingPackets.Add(ClientPacketHeader.JavascriptCallbackMessageEvent, new WebOverlayCallbackEvent());

            // Gang window (WaveRP-Nitro)
            _incomingPackets.Add(ClientPacketHeader.RequestGangDataMessageEvent, new Incoming.Roleplay.Gang.RequestGangDataEvent());
            _incomingPackets.Add(ClientPacketHeader.GangCreateMessageEvent, new Incoming.Roleplay.Gang.GangCreateEvent());
            _incomingPackets.Add(ClientPacketHeader.GangSaveColorsMessageEvent, new Incoming.Roleplay.Gang.GangSaveColorsEvent());
            _incomingPackets.Add(ClientPacketHeader.GangSaveRoleMessageEvent, new Incoming.Roleplay.Gang.GangSaveRoleEvent());
            _incomingPackets.Add(ClientPacketHeader.GangDeleteRoleMessageEvent, new Incoming.Roleplay.Gang.GangDeleteRoleEvent());
            _incomingPackets.Add(ClientPacketHeader.GangInviteMessageEvent, new Incoming.Roleplay.Gang.GangInviteEvent());
            _incomingPackets.Add(ClientPacketHeader.GangInviteRespondMessageEvent, new Incoming.Roleplay.Gang.GangInviteRespondEvent());
            _incomingPackets.Add(ClientPacketHeader.GangDeleteMessageEvent, new Incoming.Roleplay.Gang.GangDeleteEvent());
            _incomingPackets.Add(ClientPacketHeader.GangMemberActionMessageEvent, new Incoming.Roleplay.Gang.GangMemberActionEvent());
            _incomingPackets.Add(ClientPacketHeader.GangUpgradeMessageEvent, new Incoming.Roleplay.Gang.GangUpgradeEvent());
            _incomingPackets.Add(ClientPacketHeader.GangSaveBadgeMessageEvent, new Incoming.Roleplay.Gang.GangSaveBadgeEvent());

            // clothing shit
            _incomingPackets.Add(ClientPacketHeader.RequestClothingStoreMessageEvent, new Incoming.Roleplay.Clothing.RequestClothingStoreEvent());
            _incomingPackets.Add(ClientPacketHeader.PurchaseClothingSetMessageEvent, new Incoming.Roleplay.Clothing.PurchaseClothingSetEvent());
        }

        private void RegisterCrafting()
        {
            _incomingPackets.Add(ClientPacketHeader.GetCraftingListMessageEvent, new GetCraftableProductsEvent());
            _incomingPackets.Add(ClientPacketHeader.GetRecipeConfigMessageEvent, new GetCraftingRecipeEvent());
            _incomingPackets.Add(ClientPacketHeader.CraftedRecipeExecutedMessageEvent, new CraftEvent());
        ...
        public void TryExecutePacket(GameClient session, ClientPacket packet)
        {
            ...
            // Guarded so the per-packet name lookup + string concatenation (this is the single
            // hottest code path in the server) only happens when debug logging is actually on.
            if (Log.IsDebugEnabled) {
                if (_packetNames.TryGetValue(packet.Id, out string packetName))
                    Log.Debug("Handled Packet: [" + packet.Id + "] " + packetName);
                else
...
#pragma warning disable CS0162
        ...
        {
            _incomingPackets.Add(ClientPacketHeader.GetUserNftChatStylesMessageEvent, new GetUserNftChatStylesEvent());
        ...
        {
            _incomingPackets.Add(ClientPacketHeader.KickMemberMessageEvent, new LeaveGroupEvent());
