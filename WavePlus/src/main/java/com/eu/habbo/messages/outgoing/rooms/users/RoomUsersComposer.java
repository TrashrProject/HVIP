...
public class RoomUsersComposer extends MessageComposer {
    ...
    protected ServerMessage composeInternal() {
        ...
        if (this.habbo != null) {
            ...
            this.response.appendInt(1);
            this.response.appendString(this.habbo.getHabboInfo().getGender().name().toLowerCase());
            this.response.appendInt(this.habbo.getHabboStats().guild != 0 ? this.habbo.getHabboStats().guild : 0);
            this.response.appendInt(0);
            ...
            for (Habbo habbo : this.habbos) {
                if (habbo != null) {
                    ...
                    this.response.appendInt(0);
                    this.response.appendInt(1);
                    this.response.appendString(habbo.getHabboInfo().getGender().name().toLowerCase());
                    this.response.appendInt(habbo.getHabboStats().guild != 0 ? habbo.getHabboStats().guild : 0);
                    this.response.appendInt(0);
                    String name = "";
