    ...
    protected ServerMessage composeInternal() {
        ...
        if (this.roomUnits != null) {
            ...
            for (RoomUnit roomUnit : this.roomUnits) {
                ...
                this.response.appendInt((int) Math.round((this.overrideZ != -1 ? this.overrideZ : roomUnit.getPreviousLocationZ()) * 1000));
            ...
            synchronized (this.habbos) {
                ...
                for (Habbo habbo : this.habbos) {
                    ...
                    this.response.appendInt((int) Math.round(habbo.getRoomUnit().getPreviousLocationZ() * 1000));
