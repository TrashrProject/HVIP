...
public class BotManager {
    ...
    public void placeBot(Bot bot, Habbo habbo, Room room, RoomTile location) {
        ...
        if (room.getOwnerId() != habbo.getHabboInfo().getId() && !habbo.hasPermission(
            Permission.ACC_ANYROOMOWNER) && !habbo.hasPermission(Permission.ACC_PLACEFURNI)) {
        ...
        roomUnit.setPreviousLocationZ(location.getStackHeight());
        roomUnit.setZ(location.getStackHeight());
