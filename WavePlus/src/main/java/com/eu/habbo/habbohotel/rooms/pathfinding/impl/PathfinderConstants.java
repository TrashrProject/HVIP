...
public final class PathfinderConstants {
  ...
  public static final String CONFIG_CHECK_ROOM_UNITS = "pathfinder.check_room_units";
  public static final String CONFIG_ALLOW_WALK_TILE_WITH_USER = "pathfinder.allow_walk.tile_with_user";
